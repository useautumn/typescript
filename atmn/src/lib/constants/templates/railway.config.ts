...
export const plans: Plan[] = [
	{
		...
		features: [
			{ feature_id: "credits", included: 500 }, // One-time grant
			{
				...
				price: { amount: 0.039, billing_method: "pay_per_use", billing_units: 1 },
			},
			{
				feature_id: "cpu_vcpu_hours",
				reset: { interval: "month" },
				price: { amount: 0.078, billing_method: "pay_per_use", billing_units: 1 },
			},
			{
				feature_id: "egress_gb",
				reset: { interval: "month" },
				price: { amount: 5, billing_method: "pay_per_use", billing_units: 1 },
			},
			{
				feature_id: "storage_gb",
				reset: { interval: "month" },
				price: { amount: 1.5, billing_method: "pay_per_use", billing_units: 1 },
			},
		],
	},
	{
