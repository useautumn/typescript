...
import { listPlansMethod } from "./clientPlanMethods";
...
export interface IAutumnClient {
	...
	// Autumn methods
	attach(args: AttachParams): Promise<Autumn.AttachResponse>;
	checkout(args: CheckoutParams): Promise<Autumn.CheckoutResponse>;
	cancel(args: CancelParams): Promise<Autumn.CancelResponse>;
	openBillingPortal(args: any): Promise<any>;
	setupPayment(args: SetupPaymentParams): Promise<Autumn.SetupPaymentResponse>;
	query(args: QueryParams): Promise<Autumn.QueryResponse>;
	check(args: any): any;
...
export class AutumnClient implements IAutumnClient {
	...
	plans = {
		list: listPlansMethod.bind(this),
	};
}
