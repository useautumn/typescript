...
export const CustomerCreateParamsSchema = z.object({
  expand: z.union([z.unknown(), z.literal('invoices'), z.literal('trials_used'), z.literal('rewards'), z.literal('entities'), z.literal('referrals'), z.literal('payment_method'), z.literal('upcoming_invoice'), z.literal('subscriptions.plan'), z.unknown()]).describe("Query param:").optional(),
  ...
  entityData: EntityDataSchema.describe("Body param: Data for creating an entity").optional(),
  entityId: z.string().describe("Body param: Entity ID to associate with the customer").optional(),
...
export interface CustomerCreateParams {
  ...
  /**
   * Body param: Data for creating an entity
   */
