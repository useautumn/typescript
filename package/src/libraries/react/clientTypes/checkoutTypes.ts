...
export const CheckoutParamsUnionMember0Schema = z.object({
...
export const CheckoutParamsItemSchema = z.object({
...
export const CheckoutParamsItemConfigSchema = z.object({
...
export const CheckoutParamsItemConfigRolloverSchema = z.object({
  length: z.number(),
  max: z.number().nullable(),
  duration: z.union([z.literal('month'), z.literal('forever')]).optional()
});

export const CheckoutParamsItemDisplaySchema = z.object({
  primaryText: z.string(),
  secondaryText: z.string().nullable().optional()
});

export const CheckoutParamsItemFeatureSchema = z.object({
...
export const CheckoutParamsItemFeatureCreditSchemaSchema = z.object({
...
export const CheckoutParamsItemFeatureDisplaySchema = z.object({
...
export const CheckoutParamsItemTierSchema = z.object({
...
export const CheckoutParamsSchema = z.object({
  ...
  items: z.array(CheckoutParamsItemSchema).optional(),
...
export interface CheckoutParamsUnionMember0 {
...
export interface CheckoutParamsItem {
  /**
...
reset date, and if there's a price, it will be billed one-off.
  ...
  config?: CheckoutParamsItemConfig | null;

  createdAt?: number | null;

  display?: CheckoutParamsItemDisplay | null;
  ...
  feature?: CheckoutParamsItemFeature | null;
   ...
   */
  tiers?: CheckoutParamsItemTier[] | null;
...
export interface CheckoutParamsItemConfig {
  ...
  rollover?: CheckoutParamsItemConfigRollover | null;
}

export interface CheckoutParamsItemConfigRollover {
  length: number;
...
export interface CheckoutParamsItemDisplay {
  primaryText: string;

  secondaryText?: string | null;
}

export interface CheckoutParamsItemFeature {
  /**
...
/check.
   ...
   */
  creditSchema?: CheckoutParamsItemFeatureCreditSchema[] | null;

  /**
   * Singular and plural display names for the feature.
   */
  display?: CheckoutParamsItemFeatureDisplay | null;
...
export interface CheckoutParamsItemFeatureCreditSchema {
  /**
...
export interface CheckoutParamsItemFeatureDisplay {
  /**
...
export interface CheckoutParamsItemTier {
  /**
...
export interface CheckoutParams {
  ...
  freeTrial?: CheckoutParamsUnionMember0 | boolean;
