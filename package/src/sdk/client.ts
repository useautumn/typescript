...
import type { QueryParams } from "./events/eventTypes";
import { featureMethods } from "./features/featureMethods";
import type { AttachParams, CheckoutParams } from "./general/attachTypes";
import {
	handleAttach,
	handleCancel,
	handleCheck,
...
export class Autumn {
	...
	async postWithVersion(path: string, body: unknown, version: string) {
		try {
			const headers = {
				...this.headers,
